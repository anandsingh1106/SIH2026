...
function toPublicMaternal(row) {
  return {
    ...
    patientVillage: row.patient_village || undefined,
    patientDateOfBirth: row.patient_dob || undefined,
    ancVisitCount: row.anc_count ?? undefined,
    latestHemoglobin: row.latest_hemoglobin ?? undefined,
    latestBp: row.latest_bp || undefined,
