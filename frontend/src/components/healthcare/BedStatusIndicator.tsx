...
export const BedStatusIndicator: React.FC<BedStatusIndicatorProps> = ({
  ...
  return (
    <div className={`rounded-xl border border-slate-200 bg-white p-4 shadow-xs space-y-4 ${className}`}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div className="bg-slate-50 p-3 rounded-lg border border-slate-100">
          <div className="text-[11px] text-slate-500 font-medium">General Wards</div>
          <div className="text-xl font-bold text-slate-900 mt-1">
            {availableBeds} <span className="text-xs font-normal text-slate-500">/ {totalBeds} free</span>
          </div>
        ...
        {/* ICU Beds */}
        <div className="bg-slate-50 p-3 rounded-lg border border-slate-100">
          <div className="text-[11px] text-slate-500 font-medium">ICU / HDU Units</div>
          <div className="text-xl font-bold text-slate-900 mt-1">
            {availableIcuBeds} <span className="text-xs font-normal text-slate-500">/ {icuBeds} free</span>
          </div>
          <div className="w-full bg-slate-200 rounded-full h-1.5 mt-2 overflow-hidden">
            <div
        ...
        <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 col-span-2 sm:col-span-1">
          <div className="text-[11px] text-slate-500 font-medium">Ventilators</div>
          <div className="text-xl font-bold text-slate-900 mt-1">
            {availableVentilators} <span className="text-xs font-normal text-slate-500">/ {ventilators} free</span>
          </div>
          <div className="w-full bg-slate-200 rounded-full h-1.5 mt-2 overflow-hidden">
            <div
