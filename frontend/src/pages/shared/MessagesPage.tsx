              ...
              return (
                <div
                  ...
                  className={`p-3.5 text-xs cursor-pointer transition-colors ${
                    isSelected ? 'bg-white font-bold border-l-4 border-l-gov-700 shadow-2xs' : 'hover:bg-slate-100'
                  }`}
                >
        ...
        <div className="flex-1 flex flex-col justify-between bg-white">
          ...
          <form onSubmit={handleSendMessage} className="p-3 border-t border-slate-200 bg-white flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 text-xs border border-slate-300 rounded-xl px-3.5 py-2.5 focus:outline-none focus:border-gov-600 focus:ring-2 focus:ring-gov-100"
            />
