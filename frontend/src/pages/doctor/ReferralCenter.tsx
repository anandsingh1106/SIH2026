            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4 text-xs">
                ...
                <div className="grid grid-cols-2 gap-3 bg-slate-50 p-3.5 rounded-xl border border-slate-200">
                  ...
                  <div>
                    <span className="text-[11px] text-slate-500 font-medium">Specialty Unit:</span>
                    <div className="font-bold text-slate-900">{selectedReferral.specialty}</div>
                  </div>
                </div>

                <div>
                  <h5 className="font-bold text-slate-800 uppercase tracking-wider mb-1">Clinical Summary & Handover Notes:</h5>
        ...
        >
          <form onSubmit={handleCreateReferral} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Destination Hospital</label>
                <select
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Required Specialty</label>
                <select
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5">Clinical Case Summary & Reasons for Transfer</label>
              <textarea
                rows={3}
                required
