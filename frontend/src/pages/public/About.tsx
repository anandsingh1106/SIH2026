      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-3">
            ...
            <h3 className="text-lg font-bold text-slate-900">Our Public Health Mission</h3>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-3">
            ...
            <h3 className="text-lg font-bold text-slate-900">Our Digital Health Vision</h3>
            <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-xs space-y-6">
          <h2 className="text-xl font-bold text-slate-900">Architectural & Ethical Pillars</h2>
